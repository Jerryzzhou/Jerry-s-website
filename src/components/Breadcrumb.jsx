...
export default function Breadcrumb({ segments }) {
  ...
  const content = (
    ...
    >
      <div className="w-full py-2 bg-[#F2F2F2]/95 rounded-none border-t border-[#111] flex items-center justify-center font-['HYPixel'] text-[12px] tracking-widest text-[#111] transition-all">

...
const chapters = [
    { left: { name: "PROLOGUE_序章", slug: "introduce" }, right: { name: "HUZHOU_湖州", slug: "huzhou" } },
    ...
    { left: { name: "SHENNONGJIA_神农架", slug: "shennongjia" }, right: { name: "CHONGQING_重庆", slug: "chongqing" } },
